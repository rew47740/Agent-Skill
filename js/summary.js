...
.then(function(data){  
    ...
    function showdata(){ 
        ...
        //     n1.innerHTML = "Phanthira Saengboon"+"<br />";
        //     t1.innerHTML="<span style ='font-size:25px'>TEAM : </span>"+dataused[i].TEAM;
        //     show1.innerHTML += '<div class="Column" tabindex="0">'+"<br />"+"<span class = bold>Agent Level : </span>"+dataused[i].P_AGENT_LEVEL+"<br />"+"<span class = bold>Number of people : </span>"+dataused[i].count+"<br />"+"<span class = bold>TOTAL SUB X : </span>"+dataused[i].TOTAL_SUB_X+"<br />"+"<span class = bold>TOTAL SUB U : </span>"+dataused[i].TOTAL_SUB_U+"<br />"+"<span class = bold>TOTAL SUB X+U : </span>"+dataused[i].TOTAL_SUB_X_U+"<br />"+"<span class = bold>TOTAL Revenue X : </span>"+dataused[i].TOTAL_Revenue_X+"<br />"+"<span class = bold>TOTAL Revenue U : </span>"+dataused[i].TOTAL_Revenue_U+"<br />"+"<span class = bold>TOTAL Revenue X+U : </span>"+dataused[i].TOTAL_Revenue_X_U+'</div>'+'</div>';
        //     s1.innerHTML="<span style ='font-size:25px'>TOTAL Revenue :  </span>"+c1;
        // }
        // if (dataused[i].MANAGER_FULLNAME=="Rasa Amatawat"){
        //     c2 += dataused[i].TOTAL_Revenue_X_U
        //     n2.innerHTML = "Rasa Amatawat"
        //     t2.innerHTML="<span style ='font-size:25px'>TEAM : </span>"+dataused[i].TEAM;
        //     show2.innerHTML += '<div class="Column" tabindex="0">'+"<br />"+"<span class = bold>Agent Level : </span>"+dataused[i].P_AGENT_LEVEL+"<br />"+"<span class = bold>Number of people : </span>"+dataused[i].count+"<br />"+"<span class = bold>TOTAL SUB X : </span>"+dataused[i].TOTAL_SUB_X+"<br />"+"<span class = bold>TOTAL SUB U : </span>"+dataused[i].TOTAL_SUB_U+"<br />"+"<span class = bold>TOTAL SUB X+U : </span>"+dataused[i].TOTAL_SUB_X_U+"<br />"+"<span class = bold>TOTAL Revenue X : </span>"+dataused[i].TOTAL_Revenue_X+"<br />"+"<span class = bold>TOTAL Revenue U : </span>"+dataused[i].TOTAL_Revenue_U+"<br />"+"<span class = bold>TOTAL Revenue X+U : </span>"+dataused[i].TOTAL_Revenue_X_U+'</div>'+'</div>';
        //     s2.innerHTML="<span style ='font-size:25px'>TOTAL Revenue :  </span>"+c2;
        // }
        // if (dataused[i].MANAGER_FULLNAME=="Sasithorn Tonthao"){
        //     c3 += dataused[i].TOTAL_Revenue_X_U
        //     n3.innerHTML = "Sasithorn Tonthao"
        //     t3.innerHTML="<span style ='font-size:25px'>TEAM : </span>"+dataused[i].TEAM;
        //     show3.innerHTML += '<div class="Column" tabindex="0">'+"<br />"+"<span class = bold>Agent Level : </span>"+dataused[i].P_AGENT_LEVEL+"<br />"+"<span class = bold>Number of people : </span>"+dataused[i].count+"<br />"+"<span class = bold>TOTAL SUB X : </span>"+dataused[i].TOTAL_SUB_X+"<br />"+"<span class = bold>TOTAL SUB U : </span>"+dataused[i].TOTAL_SUB_U+"<br />"+"<span class = bold>TOTAL SUB X+U : </span>"+dataused[i].TOTAL_SUB_X_U+"<br />"+"<span class = bold>TOTAL Revenue X : </span>"+dataused[i].TOTAL_Revenue_X+"<br />"+"<span class = bold>TOTAL Revenue U : </span>"+dataused[i].TOTAL_Revenue_U+"<br />"+"<span class = bold>TOTAL Revenue X+U : </span>"+dataused[i].TOTAL_Revenue_X_U+'</div>'+'</div>';
        //     s3.innerHTML="<span style ='font-size:25px'>TOTAL Revenue :  </span>"+c3;
        // }
        // if (dataused[i].MANAGER_FULLNAME=="Sarinda Jiakwattanachayakorn"){
        //     c4 += dataused[i].TOTAL_Revenue_X_U
        //     n4.innerHTML = "Sarinda Jiakwattanachayakorn"
        //     t4.innerHTML="<span style ='font-size:25px'>TEAM : </span>"+dataused[i].TEAM;
        //     show4.innerHTML += '<div class="Column" tabindex="0">'+"<br />"+"<span class = bold>Agent Level : </span>"+dataused[i].P_AGENT_LEVEL+"<br />"+"<span class = bold>Number of people : </span>"+dataused[i].count+"<br />"+"<span class = bold>TOTAL SUB X : </span>"+dataused[i].TOTAL_SUB_X+"<br />"+"<span class = bold>TOTAL SUB U : </span>"+dataused[i].TOTAL_SUB_U+"<br />"+"<span class = bold>TOTAL SUB X+U : </span>"+dataused[i].TOTAL_SUB_X_U+"<br />"+"<span class = bold>TOTAL Revenue X : </span>"+dataused[i].TOTAL_Revenue_X+"<br />"+"<span class = bold>TOTAL Revenue U : </span>"+dataused[i].TOTAL_Revenue_U+"<br />"+"<span class = bold>TOTAL Revenue X+U : </span>"+dataused[i].TOTAL_Revenue_X_U+'</div>'+'</div>';
        //     s4.innerHTML="<span style ='font-size:25px'>TOTAL Revenue :  </span>"+c4;
        // }
        // if (dataused[i].MANAGER_FULLNAME=="Komsan Madbamrung"){
        //     c5 += dataused[i].TOTAL_Revenue_X_U
        //     n5.innerHTML = "Komsan Madbamrung"
        //     t5.innerHTML="<span style ='font-size:25px'>TEAM : </span>"+dataused[i].TEAM;
        //     show5.innerHTML += '<div class="Column" tabindex="0">'+"<br />"+"<span class = bold>Agent Level : </span>"+dataused[i].P_AGENT_LEVEL+"<br />"+"<span class = bold>Number of people : </span>"+dataused[i].count+"<br />"+"<span class = bold>TOTAL SUB X : </span>"+dataused[i].TOTAL_SUB_X+"<br />"+"<span class = bold>TOTAL SUB U : </span>"+dataused[i].TOTAL_SUB_U+"<br />"+"<span class = bold>TOTAL SUB X+U : </span>"+dataused[i].TOTAL_SUB_X_U+"<br />"+"<span class = bold>TOTAL Revenue X : </span>"+dataused[i].TOTAL_Revenue_X+"<br />"+"<span class = bold>TOTAL Revenue U : </span>"+dataused[i].TOTAL_Revenue_U+"<br />"+"<span class = bold>TOTAL Revenue X+U : </span>"+dataused[i].TOTAL_Revenue_X_U+'</div>'+'</div>';
        //     s5.innerHTML="<span style ='font-size:25px'>TOTAL Revenue :  </span>"+c5;
        // }
        // if (dataused[i].MANAGER_FULLNAME=="Thitirat Aukkarakosaithanakul"){
        //     c6 += dataused[i].TOTAL_Revenue_X_U
        ...
        //     n7.innerHTML = "Naphat Narukasolkkul"
        //     t7.innerHTML="<span style ='font-size:25px'>TEAM : </span>"+dataused[i].TEAM;
        //     show7.innerHTML += '<div class="Column" tabindex="0">'+"<br />"+"<span class = bold>Agent Level : </span>"+dataused[i].P_AGENT_LEVEL+"<br />"+"<span class = bold>Number of people : </span>"+dataused[i].count+"<br />"+"<span class = bold>TOTAL SUB X : </span>"+dataused[i].TOTAL_SUB_X+"<br />"+"<span class = bold>TOTAL SUB U : </span>"+dataused[i].TOTAL_SUB_U+"<br />"+"<span class = bold>TOTAL SUB X+U : </span>"+dataused[i].TOTAL_SUB_X_U+"<br />"+"<span class = bold>TOTAL Revenue X : </span>"+dataused[i].TOTAL_Revenue_X+"<br />"+"<span class = bold>TOTAL Revenue U : </span>"+dataused[i].TOTAL_Revenue_U+"<br />"+"<span class = bold>TOTAL Revenue X+U : </span>"+dataused[i].TOTAL_Revenue_X_U+'</div>'+'</div>';
        //     s7.innerHTML="<span style ='font-size:25px'>TOTAL Revenue :  </span>"+c7;
        // }
        // if (dataused[i].MANAGER_FULLNAME=="Ekkaphong Panya 2"){
        //     c8 += dataused[i].TOTAL_Revenue_X_U
        //     n8.innerHTML = "Ekkaphong Panya 2"
        //     t8.innerHTML="<span style ='font-size:25px'>TEAM : </span>"+dataused[i].TEAM;
        //     show8.innerHTML += '<div class="Column" tabindex="0">'+"<br />"+"<span class = bold>Agent Level : </span>"+dataused[i].P_AGENT_LEVEL+"<br />"+"<span class = bold>Number of people : </span>"+dataused[i].count+"<br />"+"<span class = bold>TOTAL SUB X : </span>"+dataused[i].TOTAL_SUB_X+"<br />"+"<span class = bold>TOTAL SUB U : </span>"+dataused[i].TOTAL_SUB_U+"<br />"+"<span class = bold>TOTAL SUB X+U : </span>"+dataused[i].TOTAL_SUB_X_U+"<br />"+"<span class = bold>TOTAL Revenue X : </span>"+dataused[i].TOTAL_Revenue_X+"<br />"+"<span class = bold>TOTAL Revenue U : </span>"+dataused[i].TOTAL_Revenue_U+"<br />"+"<span class = bold>TOTAL Revenue X+U : </span>"+dataused[i].TOTAL_Revenue_X_U+'</div>'+'</div>';
        //     s8.innerHTML="<span style ='font-size:25px'>TOTAL Revenue :  </span>"+c8;
        // }
        // if (dataused[i].MANAGER_FULLNAME=="Ekkaphong Panya"){
        //     c9 += dataused[i].TOTAL_Revenue_X_U
        ...
        //     n10.innerHTML = "Linjee Punyayom"
        //     t10.innerHTML="<span style ='font-size:25px'>TEAM : </span>"+dataused[i].TEAM;
        //     show10.innerHTML += '<div class="Column" tabindex="0">'+"<br />"+"<span class = bold>Agent Level : </span>"+dataused[i].P_AGENT_LEVEL+"<br />"+"<span class = bold>Number of people : </span>"+dataused[i].count+"<br />"+"<span class = bold>TOTAL SUB X : </span>"+dataused[i].TOTAL_SUB_X+"<br />"+"<span class = bold>TOTAL SUB U : </span>"+dataused[i].TOTAL_SUB_U+"<br />"+"<span class = bold>TOTAL SUB X+U : </span>"+dataused[i].TOTAL_SUB_X_U+"<br />"+"<span class = bold>TOTAL Revenue X : </span>"+dataused[i].TOTAL_Revenue_X+"<br />"+"<span class = bold>TOTAL Revenue U : </span>"+dataused[i].TOTAL_Revenue_U+"<br />"+"<span class = bold>TOTAL Revenue X+U : </span>"+dataused[i].TOTAL_Revenue_X_U+'</div>'+'</div>';
        //     s10.innerHTML="<span style ='font-size:25px'>TOTAL Revenue :  </span>"+c10;
        // }
