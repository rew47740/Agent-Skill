...
.then(function(data){  
    ...
    function sortrev(prop) { 
        ...
        dataused = dataused.sort((a, b) => {
            let retval = 0;
            if (a.TOTAL_SUB_X_U < b.TOTAL_SUB_X_U)
              retval = -1;
            if (a.TOTAL_SUB_X_U > b.TOTAL_SUB_X_U)
              retval = 1;
            if (retval === 0)
